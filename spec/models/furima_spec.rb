...
RSpec.describe Furima, type: :model do
  before do
    ...
    @furima.image = fixture_file_upload('app/assets/images/star.png')
  ...
  describe '出品機能' do
    ...
    context '出品ができない時' do
      ...
      it '販売価格についての情報が必須であること' do
        @furima.price = ''
        @furima.valid?
        expect(@furima.errors.full_messages).to include("Price Half-width number", "Price Out of setting range")
      end
